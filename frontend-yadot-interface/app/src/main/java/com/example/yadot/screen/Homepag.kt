...
@Composable
fun HomePag(modifier: Modifier, navController: NavHostController, viewModel: HabitosViewModel) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(Branco)
        ...
        Column(
            modifier = Modifier.fillMaxWidth().padding(top = 50.dp).background(Branco),
